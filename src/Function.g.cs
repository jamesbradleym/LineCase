...
namespace LineCase
{
    public class Function
    {
        ...
        private IModelStore<LineCaseInputs> store;

        public async Task<LineCaseOutputs> Handler(LineCaseInputs args, ILambdaContext context)
        {
            ...
            { 
                ...
                {
                    this.store = new S3ModelStore<LineCaseInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
                }
                else
                {
                    this.store = new UrlModelStore<LineCaseInputs>();
                }
            }

            var l = new InvocationWrapper<LineCaseInputs,LineCaseOutputs> (store, LineCase.Execute);
